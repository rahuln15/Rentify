...
//       try {
//           const response = await axios.post('http://127.0.0.1:4000/api/signup', userData);
...
//     try {
//       const response = await axios.post('http://127.0.0.1:4000/api/signup', loginData);
//       return response.data;
//     } catch (err) {
//       return rejectWithValue(err.response.data);
//     }
...
//   async (loginData, { rejectWithValue }) => {
//     try {
//       const response = await axios.post('http://127.0.0.1:4000/api/login', loginData); 
//       console.log(response.data);
